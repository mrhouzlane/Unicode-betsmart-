...
contract MyDeFiProject {
    ...
    mapping(bytes32 => mapping(uint256 => uint256)) public tokenBalance; // for the questionId //mapping in the index of the collection array
    address admin;
    ...
    function createBet(bytes32 questionId, uint256 amount) external payable {
    ...
    function transferTokens(
        ...
        uint256 indexSet, //outcome collection you want , indexSet of B is 0b010 : binary value 010 and 0b : base(2)
